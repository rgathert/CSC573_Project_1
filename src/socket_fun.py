...
def p2pRecvHandler(p2p_socket, rfc_index, os_name, host_name):
    while True:
        ...
        (command_type, return_code, parsed_request) = peer_command_handle.PeerRequestParse(data, host_name, os_name)
        ...
        header = f"{VERSION_STR} {HttpStatus.OK} {returnPhrase(HttpStatus.OK)}\r\n"
